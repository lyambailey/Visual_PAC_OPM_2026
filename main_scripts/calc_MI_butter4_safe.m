...
% Modulation Index (MI). This is a modified version of the function
% used in Seymour et al. (2017)
%
% Inputs:
...
%
% Original function written by: Robert Seymour - Aston Brain Centre. July 2017.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [MI_matrix_raw,MI_matrix_surr] = calc_MI_butter4_safe(virtsens,toi,phase,amp,diag,surrogates,approach,varargin)
...
for phase_freq = phase(1):1:phase(2)
    for amp_freq = amp(1):2:amp(2)
        ...
        cfg.hilbert = 'angle';
        fprintf('Filtering phase freq: %d Hz\n', phase_freq);
        cfg.bpinstabilityfix = 'reduce';  % drops the order in the event of numerical instability
