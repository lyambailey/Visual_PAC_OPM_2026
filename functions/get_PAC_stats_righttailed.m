%% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This is a modified version of the function used by Seymour et al. (2017)
% for performing statistical analyis on the matrix of modulation index (MI)
% values computed for PAC analysis.
%
...
%
% Original function written by Robert Seymour (ABC) - January 2017
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Function modified to perform right-tailed ttests (instead of the original
% 2 tailed), for consistency with Bayesian stats - Bailey 2026
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


function [stat] = get_PAC_stats_righttailed(PAC_name1,PAC_name2,phase,amp,subject,scripts_dir,surr)
...
for i =1:length(subject)
    ...
    load([scripts_dir filesep subject{i} filesep PAC_name1]);   % modified version to work in linux. Change by LB, 27March2026
...
for i =1:length(subject)
    ...
    load([scripts_dir filesep subject{i} filesep PAC_name2]); % modified version to work in linux. Change by LB, 27March2026
    % Add FT-related data structure information
    MI_pre = [];
    MI_pre.label = {'MI'};
...
cfg.tail        = 1;    % Tail for the individual cell ttests. Right-tailed test. Modified from original (cfg.tail = 0 for 2 tailed)
cfg.clustertail = 1; % tail for cluster correction
